...
const SingleItemMusic = (props) => {
  ...
  return (
    <div key={props.index} className='flex items-center justify-center hover:bg-gradient-to-b hover:from-[#1DB954]/30 hover:to-[#189243]/30 mx-4 rounded-xl p-6 duration-300 hover:shadow-2xl hover:shadow-[#1DB954]/10'
      ...
      onClick={() => navigate(`/playerSong/${music.artist}`)}>

      <div className='flex items-center justify-center flex-col'>
        <div className='overflow-hidden relative'>
          <div className='w-[140px] h-[140px] overflow-hidden flex items-center justify-center'>
            <img src={props.image} alt="Musica" />
          </div>
...
export default SingleItemMusic